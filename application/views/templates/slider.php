<section id="hero" class="tbg1">
    <div id="layerslider-container-fw">
     ...
     <img src="<?php echo base_url();?>images/slide-pics/slide1-bg.jpg" class="ls-bg" alt="">
     ...
     <img src="<?php echo base_url();?>images/slide-pics/slide2-bg.jpg" class="ls-bg" alt=""> 
     ...
     <img src="<?php echo base_url();?>images/slide-pics/slide3-bg.jpg" class="ls-bg" alt="">
     ...
     <img src="<?php echo base_url();?>images/slide-pics/slide4-bg.jpg" class="ls-bg" alt="">
